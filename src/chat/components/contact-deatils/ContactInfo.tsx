...
export const ContactInfo = ({client}: props) => {
  return (
    ...
    <div className="flex flex-col items-center pb-6 border-b">
      <div className="h-20 w-20 rounded-full bg-green-500 transition duration-200 ease-in-out hover:bg-green-600 flex items-center justify-center text-white text-xl mb-3">
